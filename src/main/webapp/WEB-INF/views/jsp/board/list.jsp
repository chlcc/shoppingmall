                   	...
                   	<tbody id="list">
                   		<c:forEach items="${list}" var="list">
                			<tr>
								...
								<td>${list.userId}</td>
								<td><fmt:formatDate value="${list.create_at}" pattern="YY/MM/dd"/></td>
								<td>${list.viewCnt}</td>
							</tr>
                   		</c:forEach>
                   	</tbody>
...
<!-- TODO 비공개글 처리 -->
<!-- Modal -->
<div class="modal fade" id="passwordInputModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<input id="passwordInput" class="form-control" placeholder="Password를 입력해주세요"/>
      </div>
